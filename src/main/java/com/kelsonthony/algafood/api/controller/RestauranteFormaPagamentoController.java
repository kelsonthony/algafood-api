...
import com.kelsonthony.algafood.api.openapi.controller.RestauranteFormaPagamentoControllerOpenApi;
...
@RestController
@RequestMapping(value = "/restaurantes/{restauranteId}/forma-pagamento", produces = MediaType.APPLICATION_JSON_VALUE)
