...
insert into grupo (id, nome) values (3, 'Operador');
insert into grupo (id, nome) values (4, 'Caixa');

insert into usuario (id, nome, email, senha, data_cadastro) values (1, 'Joao Silva', 'joao@algafood.com', '123456', utc_timestamp);
insert into usuario (id, nome, email, senha, data_cadastro) values (2, 'Jose Silva', 'joao@algafood.com', '123456', utc_timestamp);
